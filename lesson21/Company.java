...
public class Company {
    ...
    private static int maxNumberOfEmployees = 10;

    public Company(int numberOfEmployees, String name, String licence) throws Exception{
    ...
    public static void validate() throws Exception{
        if (!licence.equals("TTT111"))
            throw new Exception("Wrong license" + licence);
    }
